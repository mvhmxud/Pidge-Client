...
export function FriendRequests({ 
  ...
  return (
    <div className="flex w-full md:w-1/2 flex-col p-4 md:p-6 h-full">
      <h2 className="mb-4 md:mb-6 text-center text-xl md:text-2xl font-semibold">Incoming requests</h2>
                ...
                <div key={request._id} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      disabled={isProcessing[`reject-${request._id}`] || isLoading}
                    >
                    ...
                    <Button
                      ...
                      disabled={isProcessing[`accept-${request._id}`] || isLoading}
                    >
